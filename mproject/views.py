...
nest_asyncio.apply()
consumer_key = "OFpuCJspKKZQ2FvUccmgkKAho" #Your API/Consumer key 
consumer_secret = "9URjw2VtnADbRLJkrIjFIgGLjND9CCvCVcXo4dd8eDscFzbWra" #Your API/Consumer Secret Key
access_token = "1287445582743658497-on3S1Fg51CUJSUNxrzdfjvtRqvLnOx"    #Your Access token key
access_token_secret = "7qTDznGSoRbAnuYonzct09Pfba080GuQFMwpl6kd8EHqn" #Your Access token Secret key
...
def search_tweet(search_item):
    ...
    #     tweets = api.search_tweets(q=search_item, lang="en", count=100, tweet_mode='extended')
        
    #     # Extract tweet texts
    #     tweet_texts = [tweet.full_text for tweet in tweets]

    #     # Create a DataFrame with tweet texts
    #     tweet_df = pd.DataFrame({'tweet': tweet_texts})
